  ...
  [179],
  {
          ...
          i
            ...
            .then((r) => {
              ...
              return Promise.resolve(
                ...
                eo(y({}, e, { err: l, Component: s, styleSheets: u, props: t }))
              )
            })
        )
      }
    ...
    6273: function (e, t, r) {
      ...
      function B() {
        return (B = n(function* (e) {
          ...
          let { pathname: r } = P.parsePath(e.asPath),
            n = x.hasBasePath(r) ? w.removeBasePath(r) : r,
      ...
      function H(e, t, r) {
        ...
        return { url: s, as: l ? u : E.addBasePath(u) }
      }
      function F(e, t) {
            ...
            let t = yield e.fetchData(),
              r = yield (function (e, t, r) {
                ...
                if (
                  ...
                  let t = P.parsePath(e),
                    u = O.formatNextPathnameInfo(
                      a(
                        {},
                        C.getNextPathnameInfo(t.pathname, {
                          nextConfig: n,
                          parseData: !0,
                        }),
                ...
                if (c) {
                  if (c.startsWith('/')) {
                    let e = P.parsePath(c),
                      t = O.formatNextPathnameInfo(
                        a(
                          {},
                          C.getNextPathnameInfo(e.pathname, {
                            nextConfig: n,
                            parseData: !0,
                          }),
                          { defaultLocale: r.router.defaultLocale, buildId: '' }
      ...
      class $ {
        ...
        change(e, t, r, o, i) {
          ...
          return n(function* () {
            let n, f
            if (!M.isLocalURL(t)) return X({ url: t, router: d }), !1
            let p = 1 === o._h
            p || (yield d._bfl(r, void 0, o.locale))
            let j =
                p ||
                o._shouldResolveHref ||
                P.parsePath(t).pathname === P.parsePath(r).pathname,
              C = a({}, d.state),
              O = !0 !== d.isReady
            d.isReady = !0
            let A = d.isSsr
            ...
            let { shallow: N = !1, scroll: B = !0 } = o,
              U = { shallow: N }
            d._inFlightRoute &&
              d.clc &&
              (A || $.events.emit('routeChangeError', k(), d._inFlightRoute, U),
              d.clc(),
              (d.clc = null)),
              (r = E.addBasePath(
                b.addLocale(
                  x.hasBasePath(r) ? w.removeBasePath(r) : r,
                  o.locale,
                  d.defaultLocale
                )
              ))
            let q = S.removeLocale(
              x.hasBasePath(r) ? w.removeBasePath(r) : r,
              C.locale
            )
            d._inFlightRoute = r
            ...
            if (!p && d.onlyAHashChange(q) && !W) {
              ;(C.asPath = q),
                $.events.emit('hashChangeStart', r, U),
              ...
              try {
                ...
                throw (
                  (c.default(e) &&
                    e.cancelled &&
                    $.events.emit('routeChangeError', e, q, U),
                  e)
                )
              }
            ...
            let K = l.removeTrailingSlash(G),
              ...
              Q = !!(
                ...
                K !== J &&
                (!m.isDynamicRoute(K) ||
                  !y.getRouteMatcher(v.getRouteRegex(K))(J))
              ),
              ee =
                !o.shallow &&
                (yield D({ asPath: r, locale: C.locale, router: d }))
            if (
              (p && ee && (j = !1),
              j &&
                '/_error' !== G &&
                ...
                z.pathname === G ||
                  ((G = z.pathname),
                  (z.pathname = E.addBasePath(G)),
                  ee || (t = _.formatWithValidation(z)))),
              !M.isLocalURL(r))
            )
              return X({ url: r, router: d }), !1
            ;(Y = S.removeLocale(w.removeBasePath(Y), C.locale)),
              (K = l.removeTrailingSlash(G))
            let et = !1
            ...
            try {
              ...
              if (
                ...
                ;(K = G = l.route || K),
                  U.shallow || (V = Object.assign({}, l.query || {}, V))
                let e = x.hasBasePath(z.pathname)
                  ? w.removeBasePath(z.pathname)
                  : z.pathname
                if (
                  (et &&
                    G !== e &&
              ...
              if ('type' in l) {
                ...
                return (
                  X({ url: l.destination, router: d }), new Promise(() => {})
                )
              }
              let s = l.Component
              ...
              if ((l.__N_SSG || l.__N_SSP) && l.props) {
                if (l.props.pageProps && l.props.pageProps.__N_REDIRECT) {
                  ...
                  if (
                    ...
                    let { url: a, as: i } = H(d, t, t)
                    return d.change(e, a, i, o)
                  }
                  return X({ url: t, router: d }), new Promise(() => {})
                }
                if (
                  ((C.isPreview = !!l.props.__N_PREVIEW),
                  l.props.notFound === Z)
                ) {
                  let e
                  try {
              ...
              p &&
                ...
                (null == (en = self.__NEXT_DATA__.props)
                  ? void 0
                  : null == (ea = en.pageProps)
                  ? void 0
                  : ea.statusCode) === 500 &&
                (null == (eo = l.props) ? void 0 : eo.pageProps) &&
                (l.props.pageProps.statusCode = 500)
              let f =
                  o.shallow && C.route === (null != (ei = l.route) ? ei : K),
                h = null != (el = o.scroll) ? el : !p && !f,
                _ = null != i ? i : h ? { x: 0, y: 0 } : null,
                P = a({}, C, {
                  route: K,
                  pathname: G,
                  query: V,
              ...
              if (p && er) {
                ...
                '/_error' === d.pathname &&
                  (null == (es = self.__NEXT_DATA__.props)
                    ...
                    ? void 0
                    : eu.statusCode) === 500 &&
                  (null == (ec = l.props) ? void 0 : ec.pageProps) &&
                  (l.props.pageProps.statusCode = 500)
                try {
                  yield d.set(P, l, _)
                } catch (e) {
              ...
              $.events.emit('beforeHistoryChange', r, U),
              ...
              if (!S) {
                ...
                if (l.error)
                  throw (
                    (p || $.events.emit('routeChangeError', l.error, q, U),
                    l.error)
                  )
                p || $.events.emit('routeChangeComplete', r, U),
        ...
        handleRouteInfoError(e, t, r, a, o, i) {
          ...
          return n(function* () {
            ...
            if (s.isAssetError(e) || i)
              throw (
                ($.events.emit('routeChangeError', e, a, o),
                X({ url: a, router: l }),
                k())
              )
            try {
              let n
              let { page: a, styleSheets: o } = yield l.fetchComponent(
                  '/_error'
                ),
            ...
            try {
              ...
              if (
                ...
                if (
                  ...
                  (s = w.removeBasePath(
                    f.normalizeLocalePath(O.effect.parsedAs.pathname, v.locales)
                      .pathname
                  )),
                  (c = v.components[e]),
                  u.shallow && c && v.route === e && !p)
                )
                  return a({}, c, { route: e })
              }
              if (j.isAPIRoute(e))
                return X({ url: i, router: v }), new Promise(() => {})
              let R =
                  x ||
                  (yield v
                    .fetchComponent(e)
        ...
        prefetch(e) {
          ...
          return n(function* () {
            ...
            let n = g.parseRelativeUrl(e),
              ...
              p = yield D({ asPath: t, locale: f, router: o })
              ...
              fetchData: () =>
                G({
                  dataHref: o.pageLoader.getDataHref({
                    href: _.formatWithValidation({ pathname: u, query: s }),
                    skipInterpolation: !0,
                    asPath: d,
                    locale: f,
                  }),
            ...
            yield Promise.all([
              ...
              o.pageLoader[r.priority ? 'loadPage' : 'prefetch'](b),
            ])
          })()
        }
        fetchComponent(e) {
        ...
        constructor(
          ...
          ;(this.sdc = {}),
            ...
            (this.onPopState = (e) => {
              ...
              ;(!this.isSsr ||
                o !== E.addBasePath(this.asPath) ||
                s !== E.addBasePath(this.pathname)) &&
          ...
          try {
            ...
            if (u.isDynamicRoute(e.pathname) && e.searchParams && r) {
              let r = n.searchParamsToUrlQuery(e.searchParams),
                { result: i, params: l } = c.interpolateAs(
                  e.pathname,
                  e.pathname,
                  r
                )

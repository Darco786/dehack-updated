    ...
    <section className='py-32 lg:py-52 text-white'>
          ...
          <div className='flex top-1/4 blur-[200px] right-1/3 -z-2 items-center absolute gradient !animate-none'>
           ...
           <div className='flex flex-col gap-10 lg:gap-14 items-center relative z-0'>
              <h3 className='font-[250] text-3xl px-16 spacing md:px-0 md:text-7xl text-center'>How <span className='font-normal'>DeHack</span> can help</h3>
              <div className=' w-full max-w-[1000px] line'></div>
              {width >= 768 && <div className='hidden md:grid grid-cols-4 md:grid-cols-1 lg:grid-cols-2 gap-12 mt-10'>
              <Monit
            ...
            <Prevent 
              ...
              <h4 className='text-[25px] md:text-[45px] font-[250] text-center px-10 lg:px-20'>DeHack brings <span className='font-normal'>AI</span> to blockchain to improve <span className='font-normal'>security, scalability, adoption & experience</span></h4>
           </div>
          </Container>
    </section>
  )

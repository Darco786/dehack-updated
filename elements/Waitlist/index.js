  ...
  return (
    <section className='py-20 px-4 text-white' id='join'>
        ...
        <div className='p-8 md:p-12 lg:p-32 bg-black/50 flex flex-col text-center items-center gap-4 border border-white/20 rounded-[20px] md:rounded-[40px]'>
            ...
            <h2 className={`${IBM.className} uppercase font-bold text-5xl md:text-7xl`}>WAITLIST</h2>
            ...
            <input className='p-3 rounded-md outline-none border-none pl-4' placeholder='Name' type='text' />
            <input className='p-3 rounded-md outline-none border-none pl-4' placeholder='Email' type='email' />
            <button className='px-10 md:w-[200px] h-[45px] border-[3px] mx-auto md: border-white rounded-md mt-auto'>Submit</button>
            </form>
        </div>
        </Container>
    </section>

    ...
    <section className="pb-20 md:pb-24 lg:pb-32 px-4 text-white">
      <Container className="relative">
        <div className="flex flex-col gap-10 lg:gap-14 items-center">
          <h3 className="font-[250] px-14 md:px-0 text-3xl md:text-4xl lg:text-7xl text-center spacing">
            How <span className="font-normal">DeHack</span> Secures
          </h3>
          <div className="w-full max-w-[1000px] line"></div>
          {width >= 768 && (
            <div className="hidden md:grid grid-cols-4 works-wrapper gap-4 xl:gap-10 gap-y-20 mt-10">
              <WorkItem
                image={images[0]}
                title="DeFi"
